...
import { Bell, MessageCircle, ArrowRight, Play, X, Eye, EyeOff, Star, Shield, Users, Zap, Award, Bot, Infinity, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen">
      ...
      <footer className="relative overflow-hidden bg-slate-900">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute inset-0" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='150' height='150' viewBox='0 0 150 150' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Cpath d='M75 0C33.58 0 0 33.58 0 75s33.58 75 75 75 75-33.58 75-75S116.42 0 75 0zm0 138.46c-35.02 0-63.46-28.44-63.46-63.46S39.98 11.54 75 11.54s63.46 28.44 63.46 63.46-28.44 63.46-63.46 63.46z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
              ...
              <div className="space-y-6 md:col-span-1">
                ...
                <div className="flex space-x-4">
                  <Button size="sm" variant="ghost" className="text-white/60 hover:text-white p-3 hover:bg-white/10 rounded-full transition-all duration-300 hover:scale-110">
              ...
              <div className="space-y-6">
                <h3 className="font-black text-2xl text-white mb-6 relative">
                  Platform
                ...
                <ul className="space-y-4 text-white/70 text-lg">
                  ...
                  <li>
                    <Link href="/pricing" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-emerald-400">Pricing</span>
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4 text-white/70 text-lg">
                  <li>
                    <Link href="/help-center" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-emerald-400">Help Center</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-us" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-teal-400">Contact Us</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/community" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-cyan-400">Community</span>
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4 text-white/70 text-lg">
                  <li>
                    <Link href="/privacy-policy" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-orange-400">Privacy Policy</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/terms-of-service" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-red-400">Terms of Service</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/cookie-policy" className="hover:text-white transition-all duration-300 hover:translate-x-2 block group">
                      <span className="group-hover:text-pink-400">Cookie Policy</span>
                    </Link>
                  </li>
                </ul>
              </div>
            ...
            <div className="border-t border-white/10 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center text-white/60">
                <p className="text-lg flex items-center">
                  &copy; 2025 Thryve. All rights reserved.
                  <span className="ml-2 text-pink-400">💪</span>
                </p>
                <p className="text-lg mt-4 md:mt-0 flex items-center">
                  Built with love for the wellness community.
